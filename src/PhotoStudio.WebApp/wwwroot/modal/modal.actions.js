...
var ModalActionCreator = (function () {
    function ModalActionCreator($rootScope, dispatcher) {
        ...
        this.open = function (options) { return _this.dispatcher.dispatch(new OpenModalAction(options.html)); };
        this.close = function () { return _this.dispatcher.dispatch(new CloseModalAction()); };
